...
export const katipProps = {
  stripPunctuation: booleanProp("katip.stripPunctuation", true),
  stripCapitals: booleanProp("katip.stripCapitals", false),
} as const;
...
export function toCompositeSettings(settings: Settings): CompositeSettings {
  ...
  return {
    ...
    textInput,
    textDisplay,
    stripPunctuation: settings.get(katipProps.stripPunctuation),
    stripCapitals: settings.get(katipProps.stripCapitals),
  };
}
